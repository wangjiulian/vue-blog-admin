...
<head>
	...
	<title>INSPINIA | Resizeable Panels</title>
	...
	<link href="<?=ADMIN_THEME?>/css/plugins/jQueryUI/jquery-ui.css" rel="stylesheet">
			...
			<ul class="nav metismenu" id="side-menu">
				...
				<li class="active">
					...
					<ul class="nav nav-second-level">
						...
						<li class="active"><a href="resizeable_panels.html">Resizeable Panels</a></li>
			...
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">
						<strong>Resizeable panels</strong>
					</li>
				</ol>
			</div>
		</div>
