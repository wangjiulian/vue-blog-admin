		...
		<div class="col-lg-12">
			<div class="ibox">
				<div class="ibox-title">
					<label><input id="hot" type="checkbox" class="i-checks"><span
							style="margin-left: 10px; height: 20px;line-height: 20px;">推荐</span></label>
					<div class="form-group ">
						<label class="col-form-label">文章标题</label>
						<input class="form-control col-sm-12" id="title" placeholder="请输入标题"/>
					</div>
				</div>
				...
				<div class="ibox-footer">
					<button class="btn btn-success col-sm-12" onclick="if(confirm('确定要发布吗')) release_blog() ">发布
					</button>
				</div>
			</div>
		</div>
...
<script>
	...
	function release_blog() {
		...
		$.ajax({
			url: '/blog/index/blog_add',
			method: 'post',
			data: {title: title, content: content, hot: hot},
			dataType: 'json',
